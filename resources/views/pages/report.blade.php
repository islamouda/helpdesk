          ...
          <div class="col-sm">
                <div class="card border-danger">
                        ...
                        <div class="card-body ">
                          ...
                          <hr>
                          <p class="card-text" style="display:inline; margin-right:1rem;">Ticket : {{ $today_ticket }}</p>
                          <p class="card-text" style="display:inline; margin-right:1rem;">Open Ticket  : {{ $today_open_ticket }}</p>
                          <p class="card-text" style="display:inline; margin-right:1rem;">Close Ticket  : {{ $today_close_ticket }}</p>
                          <hr>
